...
/**
* @see \App\Http\Controllers\Web\EmailVerificationPageController::notice
* @see Http/Controllers/Web/EmailVerificationPageController.php:29
* @route '/email/verify'
*/
...
/**
* @see \App\Http\Controllers\Web\EmailVerificationPageController::verify
* @see Http/Controllers/Web/EmailVerificationPageController.php:43
...
/**
* @see \App\Http\Controllers\Web\EmailVerificationPageController::send
* @see Http/Controllers/Web/EmailVerificationPageController.php:53
...
const EmailVerificationPageController = { notice, verify, send }

export default EmailVerificationPageController