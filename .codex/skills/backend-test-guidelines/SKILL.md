...
description: |
  Comprehensive PHPUnit and Laravel testing guidelines for 7-layer architecture. Covers Unit tests for UseCase layer (with mocked Repository), Feature tests for Repository/Controller layers. Reference this skill when creating or updating backend test code during Phase 2 (Testing & Review).
---
